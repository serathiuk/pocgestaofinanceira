	...
	<div class="grid">
		<div class="col-12">
			<div class="card">
				...
				<DataTable ref="dt" :value="statusRecebimento" dataKey="id" :paginator="true" :rows="10"
					...
					<template #header>
						<div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
							<h5 class="m-0">Status de Recebimento</h5>
						</div>
					</template>
...
<script>
const API_RESOURCE = '/integracao/recebimento';
...
export default {
	...
	mounted() {
		this.atualizarStatusRecebimento();
	},
	...
	methods: {
		...
		atualizarStatusRecebimento() {
			this.axios.get(API_RESOURCE)
				.then(resp => this.statusRecebimento = resp.data);
		}
